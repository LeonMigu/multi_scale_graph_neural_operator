...
if __name__ == "__main__":
    ...
    cycle_type = "w"  # choice between v,w and f
    ...
    model = KernelInduced(
        ...
        in_cycle_shared=in_cycle_shared,
    ).to(device)
        ...
        with torch.no_grad():
            for batch in test_loader:
                ...
                out = u_normalizer.decode(
                    ...
                    sample_idx=batch.sample_idx.view(batch_size2, -1),
                )
